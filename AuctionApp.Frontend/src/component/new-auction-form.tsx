...
export default function NewAuctionForm() {
    ...
    //     const startIndex = fullUrl.lastIndexOf('/') + 1;
    //     const endIndex = fullUrl.indexOf('?');
            ...
            <form onSubmit={handleNewAuction} className="bg-white p-2 rounded-lg">
                ...
                <div className="mb-4">
                    ...
                    <input type="file" id="image" name="image" accept="image/*, video/*" onChange={handleFileChange}
                        className="w-full border bg-gray-300 text-blue-800 border-gray-300 rounded-md py-2 px-3 placeholder-gray-400 focus:outline-none focus:ring focus:border-blue-500 mb-4" />
